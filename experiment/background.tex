...
\section{実験2の結果}
次からの実験では, ロボットの位置を比較する. \figref{Fig:Base position}のグラフが基準の値の時のロボットの位置である. このロボットの位置のグラフにおけるゴールは, x座標-275～-270, y座標-380～-370の所である.また,スタート地点を基準にしているため\figref{Fig:Base position}のようなグラフになっている.
% \begin{figure}[H]
%   \centering
%  \includegraphics[keepaspectratio, scale=0.6]
%       {images/1.png}
