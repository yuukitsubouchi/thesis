...
実験の結果，調査対象とした28のパラメータの中から，ロボットの走行安定性や経路追従性能に大きな影響を与えるものを確認することができた．これらの結果から，Navigation2 におけるパラメータ調整の指針を得ることができ，今後のロボット調整作業の効率化や，問題の挙動の原因究明に繋がることが示された．
...
As a result of the experiments, among the 28 parameters investigated, we identified several parameters that have a significant impact on the robot’s driving stability and path-following performance. These findings provide practical guidelines for parameter tuning in Navigation2 and demonstrate the potential to improve the efficiency of robot tuning and facilitate the identification of causes of undesirable behaviors in future autonomous navigation systems.
%
